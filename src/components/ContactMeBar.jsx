...
import "./ContactMeBar.css";
import ScrollProgressBar from "./ScrollProgressBar";

function ContactMeBar({mainPageRef}) {
  return (
    <div className="contact-bar">
      <div className="contact-content">
        ...
        <div className="resume-button">
          <a href="/assets/BENFATAH-YASSINE-CV.pdf" target="_blank" className="resume">
            Resume
          </a>
        </div>
      </div>
      <ScrollProgressBar mainPageRef={mainPageRef}/>
    </div>
  );
}
